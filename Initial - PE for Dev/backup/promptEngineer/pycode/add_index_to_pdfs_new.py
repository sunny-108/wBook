...
This version creates new files with "_with_index" suffix rather than replacing the originals.
"""
...
logger = logging.getLogger('add_index_to_pdfs_new')
...
def append_index_to_pdfs():
    """Add index page to all PDFs in the output directory, creating new files."""
    ...
    for pdf_file in pdf_files:
        # Create a new output filename with "_with_index" suffix
        output_file = OUTPUT_DIR / f"{pdf_file.stem}_with_index.pdf"
        ...
        logger.info(f"Added index to {pdf_file}, saved as {output_file}")
