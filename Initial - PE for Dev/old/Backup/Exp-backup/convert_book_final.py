...
This final version fixes the ID issues to ensure links work properly in the PDF.
"""
...
logger = logging.getLogger('md2pdf_fixed_navigation')
...
def convert_md_to_html_with_ids(md_content: str, chapter_num: Optional[int] = None) -> str:
    ...
    # First, extract all headings to create IDs
    headings = extract_headings_from_markdown(md_content)
...
def main():
    ...
    try:
        ...
        # Convert HTML to PDF
        pdf_path = OUTPUT_DIR / "book_final.pdf"
