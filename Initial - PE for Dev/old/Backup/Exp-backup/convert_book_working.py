#!/usr/bin/env python
"""
Final script to convert Markdown chapter files to a single HTML file then to PDF with working navigation.
This version ensures proper ID mapping for links to work.
"""
...
logger = logging.getLogger('md2pdf_working_navigation')
...
def main():
    ...
    try:
        ...
        # Save the generated HTML file (useful for debugging)
        html_path = save_html_file(complete_html, "complete_book.html")
        
        # Convert HTML to PDF
        pdf_path = OUTPUT_DIR / "book_working.pdf"
        html_to_pdf(html_path, pdf_path)
        
        logger.info(f"Book successfully created with working navigation: {pdf_path}")
